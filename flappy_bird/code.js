...
var pipes = [ [250, 200, 50, 150],[350, 150, 50, 100],[480, 250, 50, 50] ]; // [x, y, w, h] of the passage
var pipe_dx = -2;
var birdY = 100;
var g = 0.1;
...
function init () {
    pipes = [ [250, 200, 50, 150],[350, 150, 50, 100],[480, 250, 50, 50] ];
    birdY = 100;
    birdDy = 0; // delta y, the increasement of birdY in an interval
    score = 0; 
    clearInterval(timer);// stop the previous one if any
